...
class ConsumptionRequest
{
     ...
     * @param string $appAccountToken          The UUID of the in-app user account that completed the consumable in-app purchase transaction.
     * @param int    $consumptionStatus        A value that indicates the extent to which the customer consumed the in-app purchase.<br/>
     *                                         Possible Values<br/>
     ...
     * @param bool   $customerConsented        A Boolean value that indicates whether the customer consented to provide consumption data.
     * @param int    $deliveryStatus           A value that indicates whether the app successfully delivered an in-app purchase that works properly. <br/>
     *                                         Possible Values <br/>
     ...
     * @param int    $lifetimeDollarsPurchased A value that indicates the total amount, in USD, of in-app purchases the customer has made in your app, across all platforms.<br/>
     *                                         Possible Values <br/>
     ...
     * @param int    $lifetimeDollarsRefunded  A value that indicates the dollar amount of refunds the customer has received in your app, since purchasing the app, across all platforms. <br/>
     *                                         Possible Values <br/>
     ...
     * @param int    $playTime                 A value that indicates the amount of time that the customer used the app.<br/>
     *                                         Possible Values <br/>
     ...
     * @param bool   $sampleContentProvided    A Boolean value that indicates whether you provided, prior to its purchase, a free sample or trial of the content, or information about its functionality. <br/>
    ...
    /**
     * @var int A value that indicates whether the app successfully delivered an in-app purchase that works properly. <br/>
     * Possible Values <br/>
     * 0 The app delivered the consumable in-app purchase and it’s working properly.<br/>
     * 1 The app didn’t deliver the consumable in-app purchase due to a quality issue.<br/>
     * 2 The app delivered the wrong item.<br/>
    ...
    /**
     * @var int A value that indicates the total amount, in USD, of in-app purchases the customer has made in your app, across all platforms.<br/>
     * Possible Values <br/>
     * 0 Lifetime purchase amount is undeclared.<br/>
     * 1 Lifetime purchase amount is 0 USD.<br/>
     * 2 Lifetime purchase amount is between 0.01–49.99 USD.<br/>
    ...
    /**
     * @var int A value that indicates the dollar amount of refunds the customer has received in your app, since purchasing the app, across all platforms. <br/>
     * Possible Values <br/>
     * 0 Lifetime refund amount is undeclared.<br/>
     * 1 Lifetime refund amount is 0 USD.<br/>
     * 2 Lifetime refund amount is between 0.01–49.99 USD.<br/>
